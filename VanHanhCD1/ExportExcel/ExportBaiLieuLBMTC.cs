...
{
    public class ExportBaiLieuLBMTC
    {
        ...
        private readonly ILogger<ExportBaiLieuLBMTC> _logger;
        public ExportBaiLieuLBMTC(ILogger<ExportBaiLieuLBMTC> logger)
        {
            _logger = logger;
        }
