...
namespace VanHanhCD1.ExportExcel
{
    public class ExportQuatGio
    {
        ...
        private readonly ILogger<ExportLBDO1> _logger;

        public ExportQuatGio(ILogger<ExportLBDO1> logger)
        {
            _logger = logger;
        }
            ...
            string dayFrom, string dayTo)
        {
            ...
            var cellSheetFrom = sheet.Cell("A7");
            var cellSheetTo = sheet.Cell("A19");
