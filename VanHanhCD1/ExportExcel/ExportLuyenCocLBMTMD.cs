...
{
    public class ExportLuyenCocLBMTMD
    {
        ...
        private readonly ILogger<ExportLuyenCocLBMTMD> _logger;

        public ExportLuyenCocLBMTMD(ILogger<ExportLuyenCocLBMTMD> logger)
        {
            _logger = logger;
        }
            ...
            string dayFrom, string dayTo)
        {
            ...
            var cellSheetFrom = sheet.Cell("C5");
            var cellSheetTo = sheet.Cell("O5");
