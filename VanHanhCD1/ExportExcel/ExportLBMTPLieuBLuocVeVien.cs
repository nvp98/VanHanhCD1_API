...
{
    public class ExportLBMTPLieuBLuocVeVien
    {
        private const string TemplateSheetNameOne = "Sheet1";
        private const string TemplateSheetNameTwo = "Sheet2";
        private const int DefaultSymbolColumn = 5; //column E
        private const int DefaultSymbolRow = 6;
        private const int HoursInBlock = 24;
        private const int DataStartColumn = 6;
        private readonly ILogger<ExportLBMTPLieuBLuocVeVien> _logger;
        public ExportLBMTPLieuBLuocVeVien(ILogger<ExportLBMTPLieuBLuocVeVien> logger)
        {
            _logger = logger;
        }
