...
{
    public class ExportLuyenCocMayNghien
    {
        ...
        private readonly ILogger<ExportLuyenCocMayNghien> _logger;

        public ExportLuyenCocMayNghien(ILogger<ExportLuyenCocMayNghien> logger)
        {
            _logger = logger;
        }
            ...
            string dayFrom, string dayTo)
        {
            ...
            var cellSheetFrom = sheet.Cell("C7");
            var cellSheetTo = sheet.Cell("O7");
