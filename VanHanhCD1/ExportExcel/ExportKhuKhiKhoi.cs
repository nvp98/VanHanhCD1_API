...
namespace VanHanhCD1.ExportExcel
{
    public class ExportKhuKhiKhoi
    {
        ...
        private readonly ILogger<ExportKhuKhiKhoi> _logger;

        public ExportKhuKhiKhoi(ILogger<ExportKhuKhiKhoi> logger)
        {
            _logger = logger;
        }
