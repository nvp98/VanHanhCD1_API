...
namespace VanHanhCD1.ExportExcel
{
    public class ExportQHCVeVien
    {
            ...
            string dayFrom, string dayTo)
        {
            ...
            var cellSheet = sheet.Cell("E5");
            var cellSheetFrom = sheet.Cell("A9");
            var cellSheetTo = sheet.Cell("A21");
