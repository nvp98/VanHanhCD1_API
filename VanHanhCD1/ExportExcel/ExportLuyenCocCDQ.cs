...
{
    public class ExportLuyenCocCDQ
    {
        ...
        private readonly ILogger<ExportLuyenCocCDQ> _logger;

        public ExportLuyenCocCDQ(ILogger<ExportLuyenCocCDQ> logger)
        {
            _logger = logger;
        }
            ...
            string dayFrom, string dayTo)
        {
            ...
            var cellSheetFrom = sheet.Cell("C6");
            var cellSheetTo = sheet.Cell("O6");
